			...
			try(Scanner scanner = new Scanner(System.in);){
				...
				do {
					try {
						...
						AdminService adminService=LMSFactory.getAdminService();
						AdminUserService adminUser=LMSFactory.getAdminUsersService();
						...
						case 1:
							...
							ai.setRole(regRole);
							try {
								boolean check=adminUser.register(ai);
								if(check) {
						...
						case 2:
							...
							try {
								User loginInfo=adminUser.login(email, password);
									...
									do {
										try {
											...
											case 1:
												...
												try {
													boolean check2=adminService.addBook(bi);
													if(check2) {
														System.out.println("-----------------------------------------------");
											...
											case 2:
												...
												try {
													boolean check3=adminService.removeBook(removeId);
													if(check3) {
														System.out.println("-----------------------------------------------");
											...
											case 3:
												...
												try {
													boolean check4=adminService.issueBook(issueId,userId);
													if(check4) {
														System.out.println("-----------------------------------------------");
											...
											case 4:
												...
												try {
													List<Book> bookauthor = adminUser.searchBookByAuthor(author);
											...
											case 5:
												...
												try {
													List<Book> booktitle = adminUser.searchBookByTitle(btitle);
													System.out.println(String.format("%-10s %-15s %-15s %-15s %s", "BookId","BookName","BookAuthor","BookCategory","BookPublisherName"));
											...
											case 6:
												try {
													List<Book> info = adminUser.getBooksInfo();
													System.out.println(String.format("%-10s %-15s %-15s %-15s %s", "BookId","BookName","BookAuthor","BookCategory","BookPublisherName"));
											...
											case 7:
												...
												try {
													List<Book> bId = adminUser.searchBookById(book_Id);
													System.out.println(String.format("%-10s %-15s %-15s %-15s %s", "BookId","BookName","BookAuthor","BookCategory","BookPublisherName"));
											...
											case 8:
												...
												try {
													boolean updated = adminService.updateBook(bean2);
													if (updated) {
														System.out.println("-----------------------------------------------");
											...
											case 10:
												...
												try {
													List<RequestDetails> requests = adminService.showRequests();
													System.out.println(String.format("%-10s %-15s %-15s %-15s %s", "UserId","UserName","","BookId","BookName"));
													for (RequestDetails requestBean : requests) {	
														if (requestBean != null) {
															System.out.println("-----------------------------------------------");
															System.out.println(String.format("%-10s %-15s %-15s %-15s %s", 
															requestBean.getuId(),
															requestBean.getFullName(),
															requestBean.getbId(),
															requestBean.getBookName()));
														} else {
															System.out.println("-----------------------------------------------");
											...
											case 12:
												...
												try {
													...
													System.out.println(String.format("%-10s %-15s %-15s %-15s %s","UsetId","FirstName","LastName","EmailId","Password","MobileNo","UserRole"));
													for (User Bean : users) {	
														if (Bean != null) {
															System.out.println("-----------------------------------------------");
															System.out.println(String.format("%-10s %-15s %-15s %-15s %s",
											...
											case 13:
												...
												try {
													boolean updated = adminUser.updatePassword(email_Id, old_Password, new_Password, user_Role);
													if (updated) {
														System.out.println("-----------------------------------------------");
											...
											case 2:
												...
												try {
													if(loginInfo.getuId()==user_Id) {
														...
														System.out.println(String.format("%-10s %-15s %-15s %-15s %s","UserId","BookId","EmailId"));
